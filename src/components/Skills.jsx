...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={sectionRef} className="py-24 bg-zinc-950/20">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.items.map((item, itemIdx) => (
                    <span 
                      key={itemIdx}
                      className="px-3 py-1.5 text-xs font-medium bg-zinc-900/60 border border-zinc-800/80 rounded-md text-zinc-300 hover:text-white hover:border-zinc-700 transition-colors"
                    >
                      {item}
                    </span>
                  ))}

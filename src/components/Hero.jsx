...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#7c3aed04_1px,transparent_1px),linear-gradient(to_bottom,#7c3aed04_1px,transparent_1px)] bg-[size:3.5rem_3.5rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_80%,transparent_100%)] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 text-center z-10 select-none">
        ...
        <h1 className="hero-fade text-4xl sm:text-7xl md:text-8xl font-extrabold tracking-tight text-purple-950 mb-6">
          UMAKANT BHENDARKAR
        </h1>

        {/* Roles / Tech tagline */}
        <p className="hero-fade text-lg sm:text-2xl text-zinc-600 font-medium tracking-tight mb-6 max-w-3xl mx-auto">
          Full Stack Developer &bull; <span className="text-purple-950 font-semibold underline decoration-purple-300 decoration-2 underline-offset-4">MERN Core Specialist</span>
        </p>

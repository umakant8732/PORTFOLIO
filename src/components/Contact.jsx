...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 bg-zinc-950/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="contact-header text-center mb-16">
          ...
          <div className="w-12 h-0.5 bg-zinc-700 mx-auto mt-4" />
        </div>
          ...
          <div className="contact-fade lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              <a 
                ...
                className="flex items-center gap-4 p-4 rounded-xl glass-card transition-colors hover:border-zinc-500"
              >
                <div className="w-10 h-10 rounded-lg bg-zinc-900 flex items-center justify-center border border-zinc-800 shrink-0">
                  <Mail className="w-4 h-4 text-white" />
                </div>
                <div>
                  <div className="text-xs text-zinc-500 font-medium">Email Me</div>
                  <div className="text-sm font-semibold text-white break-all">umakantbhendarkar94@gmail.com</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <div className="text-xs text-zinc-500 font-medium">Call Me</div>
                  <div className="text-sm font-semibold text-white">+91 9588418970</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-semibold text-white">Nagbhid, Maharashtra, India</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950/60 border border-zinc-800 rounded-lg px-4 py-3 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-zinc-500 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-950/60 border border-zinc-800 rounded-lg px-4 py-3 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-zinc-500 transition-colors resize-none"
                />
              </div>
              ...
              >
                {status === 'sending' ? (
                  ...
                  <>
                    <Send className="w-4.5 h-4.5 text-zinc-950" />

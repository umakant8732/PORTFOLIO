...
export default function Education() {
  ...
  return (
    <section id="education" ref={sectionRef} className="py-24 bg-zinc-950/20">
            ...
            >
              <div>
                <div className="flex items-center gap-3.5 mb-6">
                  <div className="w-12 h-12 rounded-lg bg-zinc-900 flex items-center justify-center border border-zinc-800 shrink-0">
              ...
              {/* Stats & Meta Footer */}
              <div className="pt-6 border-t border-zinc-900/60 flex flex-wrap items-center justify-between gap-4">
                ...
                {/* Score badge */}
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-semibold text-white">
